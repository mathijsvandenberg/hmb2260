...
unsigned char mem(unsigned long address)
{
	...
	switch(remainder)
	{
		case 0: result = (data >> 0) & 0xFF;break;
		case 1: result = (data >> 8) & 0xFF;break;
		case 2: result = (data >> 16) & 0xFF;break;
		case 3: result = (data >> 24) & 0xFF;break;
	}
	return result;
}
...
unsigned long int2seg(int i)
{
	...
	switch(i)
	{
		...
		case 'A': s=0b01110111;break;
		case 'E': s=0b01111001;break;
		case 'L': s=0b00111000;break;
		case 'F': s=0b01110001;break;
		case 'b': s=0b01111100;break;
		case 't': s=0b01111000;break;
		case ' ': s=0b00000000;break;			
	}
	return ~s;
}
...
void c_entry()
{
	...
	// Boot success! Some LCD notification to show we reached this point
	lcd_splash_screen();
	...
	for (unsigned long a=0x0;a<0x20000000;a=a+0x200) // 1.000.000 x 512 bytes = 512MB
	{
		readnand(a);
		dumpnand(a);
	}
